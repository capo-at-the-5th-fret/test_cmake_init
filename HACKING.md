...
hidden if the `test_cmake_init_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `test_cmake_init_DEVELOPER_MODE` to the configure
